                                ...
                                <div class="panel-body">
                                    <form action="edit" method="post">
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                <td> image </td>
                                                <td><input value="${detail.getImage()}" name="images" type="text" class="form-control" required></input></td>
                                            </tr>
                                            <tr>
                                                <td>color </td>
                                            ...
                                            <tr>
                                                <td><input type="submit"  class="btn btn-danger btn-block" value="Update"></td>
                                            </tr>
